...
def json_to_csv():
    with open("/Users/frankie/Realtime/Data/tripUpdate/trip_update.json", "r") as read_file:
    ...
    df.to_csv('/Users/frankie/Realtime/Data/tripUpdate/trip_update_' + file_date + '.csv', index=False)
