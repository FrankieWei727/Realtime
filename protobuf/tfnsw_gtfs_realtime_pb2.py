...
_TRIPUPDATE_STOPTIMEUPDATE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='schedule_relationship', full_name='transit_realtime.TripUpdate.StopTimeUpdate.schedule_relationship',
            index=4,
...
_TFNSWVEHICLEDESCRIPTOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='wheelchair_accessible', full_name='transit_realtime.TfnswVehicleDescriptor.wheelchair_accessible',
            index=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='performing_prior_trip', full_name='transit_realtime.TfnswVehicleDescriptor.performing_prior_trip',
            index=3,
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='special_vehicle_attributes',
            full_name='transit_realtime.TfnswVehicleDescriptor.special_vehicle_attributes', index=4,
            number=5, type=5, cpp_type=1, label=1,
            has_default_value=True, default_value=0,
            message_type=None, enum_type=None, containing_type=None,
            is_extension=False, extension_scope=None,
