...
p.add_option('-w', '--wait', default=60, type='int', metavar='SECS',
...
p.add_option('-b', '--once', default=False, dest='once', action='store_true',
             help='only run the loader one time')

p.add_option('-k', '--apikey', default="fGd82x1Rmc54VbqZR7DUj6wFDY9RjGb5FJrm", dest='apiKey',
